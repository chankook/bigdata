...
for(i in d){
  for(w in g){
    ...
    comments1 = html_nodes(htxt, 'div.gG0TJc')
    article.links1 = html_nodes(comments1, 'h3.r.dO0Ag')
    ...
    # 매체 추출
    htxt = read_html(h)
    comments2 = html_nodes(htxt, 'div.slp')
    #comments2 = html_nodes(comments2, 'span.xQ82C.e8fRJf')
    ...
    # 날짜 추출
    comments3 = html_nodes(htxt, 'div.slp')
    comments3 = html_nodes(comments3, 'span.f.nsa.fwzPFf')
    ...
    comments4 = html_nodes(htxt, 'div.st')    
