...
for(n in d){
  for(i in g){
    ...
    article.links1 = html_nodes(comments1, 'a._sp_each_title')
    ...
    # media extraction
    comments2 = html_nodes(htxt, 'dd.txt_inline')
    comments2 = html_nodes(comments2, 'span._sp_each_source')
    ...
    # summary extraction
    comments4 = html_nodes(htxt, 'ul.type01')
